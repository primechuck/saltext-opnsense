...
def generate_exec_module_code(module: str, mod_data: dict) -> str:
    ...
    lines.append("")
    lines.append("This module wraps generic opnsense.* calls via Resources")
    lines.append("targeting T@opnsense:fw-01 via __salt__['opnsense.*']")
    lines.append('"""')
    lines.append("")
...
def generate_state_module_code(module: str, mod_data: dict) -> str:
    ...
    lines.append("")
    lines.append("Uses opnsense.item_present/absent via Salt Resources (3008+).")
    lines.append('"""')
    lines.append("")
    lines.append("import logging")
    lines.append("")
