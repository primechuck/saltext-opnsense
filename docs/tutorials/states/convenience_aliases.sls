# Convenience examples — replaces Jinja loops
# High-level wrappers hide module/controller/type/match + UUID hunting
...
# Even more convenient — completely pillar-driven, no args
